...
Stock Ocean Song animations are retained in 3.0.1. The custom model is bound to the native 106-joint skin-65 skeleton and is checked in stock minigun-idle, rocket-idle, Zapper, and recall poses.
...
2. Add `abyssal-siren-jinx_3.0.1.modpkg` to LTK Manager.
